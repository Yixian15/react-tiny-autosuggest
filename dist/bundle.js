...
var _AutoSuggest = __webpack_require__(1);

var _AutoSuggest2 = _interopRequireDefault(_AutoSuggest);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _AutoSuggest2.default;
...
var AutoSuggest = function (_Component) {
  ...
  function AutoSuggest(props) {
    ...
    _this.updateHighlightedIndex = _this.updateHighlightedIndex.bind(_this);
    _this.handleClick = _this.handleClick.bind(_this);
    _this.clearSuggestions = _this.clearSuggestions.bind(_this);
    _this.collapseSuggestions = _this.collapseSuggestions.bind(_this);
    return _this;
  }
  ...
  _createClass(AutoSuggest, [{
    ...
    value: function getSuggestions() {
      ...
      var value = this.state.valueBeforeUpDown.toUpperCase();
    ...
    value: function updateHighlightedIndex(direction) {
      ...
      if (this.state.highlightedIndex === null) {
        ...
        var nextIndex = this.state.highlightedIndex + direction;
    ...
    key: 'collapseSuggestions',
    value: function collapseSuggestions() {
      this.setState({
        isCollapsed: true,
        highlightedIndex: null
      });
